package com.minstone.generator.model;

import com.minstone.generator.vo.impl.EntityFieldImpl;
import com.minstone.generator.vo.impl.TableColumnImpl;
...
public class JTableModel extends AbstractTableModel {
    ...
    private void initTableContent(DbTable dbTable) {
        ...
        for (DasColumn column : columns) {
            ...
            ++rowIndex;
            // 第0列选中复选框
            table.put(rowIndex, ++colIndex, tableColumn.isSelected());
            // 第1列：DB列名
