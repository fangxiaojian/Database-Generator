...
import com.minstone.generator.model.TableColumnType;
import com.minstone.generator.util.IgnoreAleCommonFieldBean;
...
public class EntityFieldImpl implements IEntityField {
    ...
    public EntityFieldImpl(DasColumn dbColumn) {
        ...
        this.selected = IgnoreAleCommonFieldBean.isSelectDefault(dbColumn);
    }
