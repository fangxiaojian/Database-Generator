...
settings.modelSuffix = ${settings.modelSuffix}
settings.daoSuffix = ${settings.daoSuffix}
settings.mapperSuffix = ${settings.mapperSuffix}
settings.serviceSuffix = ${settings.serviceSuffix}
settings.serviceImplSuffix = ${settings.serviceImplSuffix}
settings.controllerSuffix = ${settings.controllerSuffix}
settings.restfulSuffix = ${settings.restfulSuffix}
settings.entityPackage = ${settings.entityPackage}
settings.modelPackage = ${settings.modelPackage}
settings.daoPackage = ${settings.daoPackage}
settings.mapperPackage = ${settings.mapperPackage}
...
settings.restfulPackage = ${settings.restfulPackage}
...
gen.setType("model") = settings.javaPath + settings.modelPackage + entity.name + settings.modelSuffix + ".java"
gen.setType("dao") = settings.javaPath + settings.daoPackage + entity.name + settings.daoSuffix + ".java"
gen.setType("mapper") = settings.javaPath + settings.mapperPackage + entity.name + settings.mapperSuffix + ".java"
gen.setType("service") = settings.javaPath + settings.servicePackage + entity.name + settings.serviceSuffix + ".java"
gen.setType("serviceImpl") = settings.javaPath + settings.serviceImplPackage + entity.name + settings.serviceImplSuffix + ".java"
gen.setType("controller") = settings.javaPath + settings.controllerPackage + entity.name + settings.controllerSuffix + ".java"
gen.setType("restful") = settings.javaPath + settings.restfulPackage + entity.name + settings.restfulSuffix + ".java"
...
3. "{idea.config.path}/extensions/com.minstone.generator.database.generator/generator/templates"
...
entity.packages.model = ${entity.packages.model}
entity.packages.model.pack = ${entity.packages.model.pack}
entity.packages.model.full = ${entity.packages.model.full}
...
entity.packages.mapper = ${entity.packages.mapper}
entity.packages.mapper.pack = ${entity.packages.mapper.pack}
entity.packages.mapper.full = ${entity.packages.mapper.full}
...
entity.packages.restful = ${entity.packages.restful}
entity.packages.restful.pack = ${entity.packages.restful.pack}
entity.packages.restful.full = ${entity.packages.restful.full}
...
entity.name.model = ${entity.name.model}
entity.name.model.firstUpper = ${entity.name.model.firstUpper}
entity.name.model.firstLower = ${entity.name.model.firstLower}
...
entity.name.mapper = ${entity.name.mapper}
entity.name.mapper.firstUpper = ${entity.name.mapper.firstUpper}
entity.name.mapper.firstLower = ${entity.name.mapper.firstLower}
...
entity.name.restful = ${entity.name.restful}
entity.name.restful.firstUpper = ${entity.name.restful.firstUpper}
entity.name.restful.firstLower = ${entity.name.restful.firstLower}
